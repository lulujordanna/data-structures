...
var content = fs.readFileSync('/home/ec2-user/environment/week07/data/locationGeo06.JSON');
...
async.eachSeries(content, function(value, callback) {
  ...
  setTimeout(callback, 2000);
    ...
    fs.writeFileSync('/home/ec2-user/environment/week07/data/locationGeo06_Update.JSON', JSON.stringify(meetingsData));
